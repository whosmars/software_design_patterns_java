...
/**
 * Clase que define el comportamiento de MeganMan. Implementa Personaje
 */
public class MeganMan implements Personaje{

    private double salud = 100.00;

    private AtaqueMeganMan ataque = new LlamasDeFuego();

    private Defensa defensa = new SinDefensa();

    private int cambiosRestantes = 3;

    private String NOMBRE_PERSONAJE = "MeganMan";
     ...
     */
    public boolean cambiarAtaque(AtaqueMeganMan nuevoAtaque){
    ...
    /** 
     * @return tring nombre que recibe la defensa
     */
